...
return [
     ...
     */
    'version' => env('NATIVEPHP_APP_VERSION', '1.0.11'),
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.panaderia.escritorio'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'Sistema local de ventas, inventario, caja y administración para panaderías.'),
     ...
     */
    // Esta aplicación no procesa trabajos en segundo plano. Evitar otro proceso
    // PHP reduce el uso de memoria y la contención de SQLite en PCs modestas.
    'queue_workers' => [],
