                ...
                <form action="{{ route('recetas.update', $receta) }}" method="POST">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group">
                                <input type="number"
                                       ...
                                       value="{{ old('rendimiento', $receta->rendimiento) }}"
                                       min="1" required>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check form-switch mt-2">
                                <input class="form-check-input" type="checkbox" id="activo" name="activo" value="1"
                                       {{ old('activo', $receta->activo) ? 'checked' : '' }}>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="descripcion" name="descripcion"
                                  rows="2">{{ old('descripcion', $receta->descripcion) }}</textarea>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="insumos-container">
                                ...
                                <div class="row mb-2 insumo-row">
                                    <div class="col-md-7">
                                        <select class="form-select" name="insumos[{{ $index }}][id]" required>
                                            <option value="">Seleccione un insumo</option>
                                            @foreach($insumos as $ins)
                                                <option value="{{ $ins->id }}"
                                                    {{ $insumo->id == $ins->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" class="form-control"
                                               ...
                                               value="{{ $insumo->pivot->cantidad_necesaria }}"
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('recetas.show', $receta) }}" class="btn btn-secondary">
