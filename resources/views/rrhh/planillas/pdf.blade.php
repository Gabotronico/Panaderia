...
<table class="detalle">
    <thead>
        ...
        <tr>
            <th class="izq" style="width:24%;">Empleado</th>
            <th style="width:10%;">Salario base</th>
            <th style="width:8%;">Valor día</th>
            ...
            <th style="width:7%;">Días efect.</th>

            <th class="corte" style="width:10%;">Ganado</th>
    ...
    <tbody>
        ...
        <tr>
            <td colspan="11" style="padding:0 4px 9px; border-bottom:1px solid #edf1f6;">
        ...
        @empty
        <tr>
            <td colspan="11" class="vacio">Esta planilla no tiene empleados asignados.</td>
        </tr>
        @endforelse
    </tbody>
    <tfoot>
