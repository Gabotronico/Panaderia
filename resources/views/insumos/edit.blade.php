                ...
                <form action="{{ route('insumos.update', $insumo->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('descripcion') is-invalid @enderror" 
                                  id="descripcion" 
                                  name="descripcion" 
                                  rows="3">{{ old('descripcion', $insumo->descripcion) }}</textarea>
                        @error('descripcion')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('unidad_medida') is-invalid @enderror" 
                                    ...
                                    <option value="unidades" {{ old('unidad_medida', $insumo->unidad_medida) == 'unidades' ? 'selected' : '' }}>Unidades</option>
                                    <option value="piezas" {{ old('unidad_medida', $insumo->unidad_medida) == 'piezas' ? 'selected' : '' }}>Piezas</option>
                                    <option value="cajas" {{ old('unidad_medida', $insumo->unidad_medida) == 'cajas' ? 'selected' : '' }}>Cajas</option>
                                    <option value="paquetes" {{ old('unidad_medida', $insumo->unidad_medida) == 'paquetes' ? 'selected' : '' }}>Paquetes</option>
                                </select>
                                @error('unidad_medida')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" 
                                       ...
                                       id="cantidad_stock" 
                                       name="cantidad_stock" 
                                       value="{{ old('cantidad_stock', $insumo->cantidad_stock) }}" 
                                       step="0.01" 
                                       min="0" 
                                       required>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" 
                                   ...
                                   name="activo" 
                                   value="1" 
                                   {{ old('activo', $insumo->activo) ? 'checked' : '' }}>
